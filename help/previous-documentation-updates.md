...
<table>
 <tbody>
  ...
  <tr>
   <td>1 maggio 2019</td> 
   <td>Guida di riferimento: visualizzatori</td> 
   <td><p>Nuova documentazione <a href="https://docs.adobe.com/content/help/it/experience-manager-65/assets/dynamic/360-video.html">Video 360/VR</a>.</p> </td> 
  </tr>
  <tr>
...
<table> 
 <tbody>
  ...
  <tr>
   ...
   <td><a href="https://helpx.adobe.com/it/experience-manager/6-2/assets/using/config-dynamic.html#setting%2520up%2520authentication">Configurazione dell’autenticazione</a></td> 
   <td>Riguarda la <a href="https://helpx.adobe.com/it/experience-manager/6-2/assets/using/config-dynamic.html">configurazione di Dynamic Media</a>.<br /> Sono stati aggiornati i passaggi per descrivere più chiaramente come si configura l’autenticazione.<br /> </td> 
  </tr>
  <tr>
   <td>17 agosto 2016</td> 
   <td><a href="https://helpx.adobe.com/it/experience-manager/6-2/assets/using/config-dynamic.html#ConfiguringImageReplication">Configurazione dell’agente di replica</a></td> 
   <td>Riguarda la <a href="https://helpx.adobe.com/it/experience-manager/6-2/assets/using/config-dynamic.html">configurazione di Dynamic Media</a>.<br /> Sono stati aggiornati i passaggi per descrivere più chiaramente come si configura l’agente di replica.</td> 
  </tr>
  <tr>
   <td>17 agosto 2016</td> 
   <td><a href="https://helpx.adobe.com/it/experience-manager/6-2/assets/using/config-dynamic.html#troubleshooting%2520authentication">Risoluzione dei problemi di autenticazione</a></td> 
   <td>Riguarda la <a href="https://helpx.adobe.com/it/experience-manager/6-2/assets/using/config-dynamic.html">configurazione di Dynamic Media</a>.<br /> Sono stati aggiunti tre nuovi argomenti per la risoluzione dei problemi di autenticazione.</td> 
  </tr>
  <tr>
   <td>4 agosto 2016</td> 
...
<table> 
 <tbody>
  ...
  <tr>
   ...
   <td><a href="https://helpx.adobe.com/it/experience-manager/6-2/assets/using/aem-assets-6-2-feature-pack-2.html">AEM Assets 6.2 FP2</a></td> 
  ...
  <tr>
   ...
   <td><a href="https://helpx.adobe.com/it/experience-manager/6-2/assets/using/config-dynamic.html#configuring%20dynamic%20media%20color%20management">Correzione dei colori in Dynamic Media</a></td> 
   <td>Istruzioni su come correggere il colore delle risorse Dynamic Media prima di visualizzarle in anteprima.</td> 
  </tr>
  <tr>
   <td>18 novembre 2016</td> 
   <td><a href="https://helpx.adobe.com/it/experience-manager/6-2/assets/using/config-dynamic.html#ConfiguringImageReplication">Configurazione della replica delle immagini</a></td> 
  ...
  <tr>
   ...
   <td>Requisiti tecnici aggiornati per Dynamic Media <a href="https://helpx.adobe.com/ca/experience-manager/aem-previous-versions.html">6.1</a>, <a href="https://helpx.adobe.com/it/experience-manager/6-2/sites/deploying/using/technical-requirements.html#dynamic-media%20add-on%20prerequisites">6.2</a></td> 
  ...
  <tr>
   ...
   <td><a href="https://docs.adobe.com/content/docs/it-IT/aem/6-1/administer/content/dynamic-media/viewer-presets.html">Visualizzatori Dynamic Media</a></td> 
   <td>I visualizzatori AEM 6.2 sono ora disponibili in AEM 6.1.</td> 
  </tr>
  <tr>
   <td>11 ottobre 2016</td> 
   <td><a href="https://docs.adobe.com/content/docs/it-IT/aem/6-1/administer/content/dynamic-media/config-dynamic.html#Configuring%20Dynamic%20Media%20Color%20Management">Gestione colore in Dynamic Media</a></td> 
   <td>Nuovo feature pack per AEM 6.1 che consente di correggere il colore delle risorse multimediali dinamiche prima di visualizzarle in anteprima.</td> 
  </tr>
  <tr>
   <td>26 settembre 2016</td> 
   <td>AEM 3D Assets</td> 
   <td>Adobe Experience Manager 3D Assets è un nuovo componente aggiuntivo per AEM che consente di caricare, gestire, visualizzare ed eseguire il rendering dei contenuti 3D. Il supporto per la visualizzazione e il rendering è ottimizzato per i singoli contenuti.
    <ul> 
     <li><a href="https://helpx.adobe.com/it/experience-manager/6-2/release-notes/aem3d-release-notes.html">Note sulla versione di AEM 3D Assets</a></li> 
     <li><a href="https://helpx.adobe.com/it/experience-manager/6-2/release-notes/aem3d-release-notes.html#InstallingandconfiguringAEM3D">Installazione e configurazione di AEM 3D Assets</a></li> 
     <li><a href="https://helpx.adobe.com/it/experience-manager/6-2/assets/using/3d-assets.html">Utilizzo di risorse 3D</a></li> 
    </ul> </td> 
  </tr>
  <tr>
  ...
  <tr>
   <td>17 agosto 2016</td> 
   <td><a href="https://docs.adobe.com/content/docs/it-IT/aem/6-1/administer/content/dynamic-media/config-dynamic.html#Setting%20up%20Authentication">Configurazione dell’autenticazione</a></td> 
   <td>Informazioni riguardo <a href="https://docs.adobe.com/content/docs/it-IT/aem/6-1/administer/content/dynamic-media/config-dynamic.html">l’impostazione di Dynamic Media</a>.<br /> Sono stati aggiornati i passaggi per descrivere più chiaramente come si configura l’autenticazione.</td> 
  </tr>
  <tr>
   <td>17 agosto 2016<br /> </td> 
   <td><a href="https://docs.adobe.com/content/docs/it-IT/aem/6-1/administer/content/dynamic-media/config-dynamic.html#Configuring%20the%20Replication%20Agent">Configurazione dell’agente di replica</a></td> 
   <td>Informazioni riguardo <a href="https://docs.adobe.com/content/docs/it-IT/aem/6-1/administer/content/dynamic-media/config-dynamic.html">l’impostazione di Dynamic Media</a>.<br /> Sono stati aggiornati i passaggi per descrivere più chiaramente come si configura l’agente di replica.</td> 
  </tr>
  <tr>
   <td>17 agosto 2016</td> 
   <td><a href="https://docs.adobe.com/content/docs/it-IT/aem/6-1/administer/content/dynamic-media/config-dynamic.html#Troubleshooting%20Authentication">Risoluzione dei problemi di autenticazione</a></td> 
   <td>Informazioni riguardo <a href="https://docs.adobe.com/content/docs/it-IT/aem/6-1/administer/content/dynamic-media/config-dynamic.html">l’impostazione di Dynamic Media</a>.<br /> Sono stati aggiunti tre nuovi argomenti sulla risoluzione dei problemi di autenticazione.</td> 
  </tr>
  <tr>
 ...
 <tbody>
  ...
  <tr>
   ...
   <td><p>Brand Portal 6.4.5 è una feature release che si propone di fornire agli utenti di Brand Portal (agenzie/team esterni) la possibilità di caricare contenuti in Brand Portal e pubblicarli in AEM Assets, senza necessità di accedere all’ambiente di authoring. Questa funzione è denominata <strong>Asset Sourcing in Brand Portal</strong>.</p> <p>La documentazione riguarda i seguenti aggiornamenti principali:</p> 
    <ul> 
     <li>È stato aggiunto <a href="https://docs.adobe.com/content/help/it/experience-manager-brand-portal/using/asset-sourcing-in-brand-portal/brand-portal-asset-sourcing.html">un video</a> che illustra il flusso di lavoro complessivo di Asset Sourcing in Brand Portal.<br /> </li> 
     ...
     <li><a href="https://docs.adobe.com/content/help/it/experience-manager-brand-portal/using/introduction/brand-portal-faqs.html">Domande frequenti</a> su Asset Sourcing.</li> 
    </ul> </td> 
  </tr>
  <tr>
   <td>20 novembre 2019 </td> 
   ...
   <td><p>Brand Portal 6.4.5 è una feature release che si propone di fornire agli utenti di Brand Portal (agenzie/team esterni) la possibilità di caricare contenuti in Brand Portal e pubblicarli in AEM Assets, senza necessità di accedere all’ambiente di authoring. Questa funzione è denominata <strong>Asset Sourcing in Brand Portal</strong>.</p> <p>La documentazione riguarda i seguenti aggiornamenti principali:</p> 
    <ul> 
     <li>È stato aggiunto un <a href="https://docs.adobe.com/content/help/it/experience-manager-brand-portal/using/asset-sourcing-in-brand-portal/brand-portal-asset-sourcing.html">video</a> che illustra il flusso di lavoro complessivo di Asset Sourcing in Brand Portal.</li> 
  ...
  <tr>
   ...
   <td>La documentazione riguarda i seguenti aggiornamenti principali:
    <ul> 
     <li><a href="https://docs.adobe.com/content/help/it/experience-manager-brand-portal/using/introduction/brand-portal-faqs.html">Domande frequenti</a> su Asset Sourcing in Brand Portal.</li> 
     <li>È stata aggiornata la documentazione di <a href="https://docs.adobe.com/content/help/it/experience-manager-brand-portal/using/asset-sourcing-in-brand-portal/brand-portal-asset-sourcing.html">Asset Sourcing in Brand Portal</a>.</li> 
    </ul> </td> 
  </tr>
  <tr>
   <td>10 ottobre 2019 </td> 
   <td>Asset Sourcing in Brand Portal</td> 
   <td><p>Documentazione su come configurare Asset Sourcing in AEM Assets e articoli correlati.</p> <p>Per la documentazione di riferimento, consulta <a href="https://docs.adobe.com/content/help/it/experience-manager-brand-portal/using/asset-sourcing-in-brand-portal/brand-portal-asset-sourcing.html">Asset Sourcing in Brand Portal</a>.</p> </td> 
  </tr>
  <tr>
   <td>28 settembre 2019</td> 
   <td>AEM Assets Brand Portal versione 6.4.5</td> 
   <td><p>Brand Portal 6.4.5 è una feature release che si propone di fornire agli utenti di Brand Portal (agenzie/team esterni) la possibilità di caricare contenuti in Brand Portal e pubblicarli in AEM Assets, senza necessità di accedere all’ambiente di authoring. Questa funzione è denominata <strong>Asset Sourcing in Brand Portal</strong>.</p> <p><a href="https://docs.adobe.com/content/help/it/experience-manager-brand-portal/using/introduction/whats-new.html#what-changed-in-645">Novità di Brand Portal 6.4.5</a></p> </td> 
  </tr>
  <tr>
   <td>8 agosto 2019</td> 
   ...
   <td><p>Hotfix rilasciati in Brand Portal 6.4.4.7 e 6.4.4.6</p> 
    ...
    </ul> <p><a href="https://docs.adobe.com/content/help/it/experience-manager-brand-portal/using/introduction/brand-portal-release-notes.html">Note sulla versione di Brand Portal</a></p> </td> 
  </tr>
  <tr>
   ...
   <td><p>Brand Portal 6.4.4 è caratterizzato da miglioramenti apportati alla ricerca di testo e in risposta alle richieste principali dei clienti.</p> <p>La documentazione riguarda i seguenti aggiornamenti principali:</p> 
    ...
    </ul> <p><a href="https://docs.adobe.com/content/help/it/experience-manager-brand-portal/using/introduction/whats-new.html">Note sulla versione di Brand Portal</a></p> <p><a href="https://docs.adobe.com/content/help/it/experience-manager-brand-portal/using/introduction/whats-new.html">Guida utente di Brand Portal</a></p> </td> 
  </tr>
  <tr>
   <td>1 novembre 2018 </td> 
   ...
   <td><p>Brand Portal versione 6.4.3 include miglioramenti per arricchire l’esperienza cliente e dare maggiore controllo alle organizzazioni.</p> <p>La documentazione riguarda i seguenti aggiornamenti principali:</p> 
    <ul> 
     ...
     <li>Consente di visualizzare in anteprima, riprodurre e scaricare i rendering di contenuti multimediali dinamici.</li> 
    ...
    </ul> <p><a href="https://docs.adobe.com/content/help/it-IT/experience-manager-brand-portal/using/introduction/whats-new.html/brand-portal/release-notes/brand-portal-release-notes-643.html" target="_blank">Note sulla versione di Brand Portal</a></p> <p><a href="https://docs.adobe.com/content/help/it/experience-manager-brand-portal/using/home.html" target="_blank">Guida utente di Brand Portal</a></p> </td> 
  </tr>
  <tr>
   <td>16 agosto 2018 </td> 
   ...
   <td><p>Brand Portal versione 6.4.2 fornisce funzionalità che rispondono alle esigenze di distribuzione delle risorse delle organizzazioni, aiutandole a raggiungere un gran numero di utenti distribuiti a livello globale con funzionalità di accesso per gli ospiti e a ottimizzare l’esperienza degli utenti con download accelerati. Questa versione offre maggiore controllo alle organizzazioni grazie a nuove configurazioni per gli amministratori.</p> <p>La documentazione riguarda i seguenti aggiornamenti principali:</p> 
    ...
    </ul> <p><a href="https://docs.adobe.com/content/help/it/experience-manager-brand-portal/using/home.html">Guida utente di Brand Portal</a></p> </td> 
  </tr>
  <tr>
   <td>17 marzo 2018</td> 
   ...
   <td><p>AEM Assets Brand Portal versione 6.4.1 costituiva un aggiornamento della piattaforma che comprendeva diverse nuove funzioni e miglioramenti fondamentali come navigazione, ricerca e prestazioni ottimizzate per soddisfare le esperienze dei clienti. La documentazione riguarda i seguenti aggiornamenti principali:</p> 
    ...
    </ul> <p><a href="https://helpx.adobe.com/it/experience-manager/brand-portal/user-guide.html">Guida utente di Brand Portal</a></p> </td> 
  </tr>
  <tr>
   ...
   <td><p>AEM Assets Brand Portal versione 6.3.1 introduce la nuova interfaccia utente di Brand Portal e una migliore esperienza di documentazione. La documentazione pratica riguarda i seguenti aggiornamenti principali:</p> 
    <ul> 
     ...
     <li>Nuovo <a href="https://experienceleague.adobe.com/docs/experience-manager-brand-portal/using/introduction/whats-new.html?lang=it#introduction">articolo sulle novità</a> con informazioni sulle funzioni nuove e aggiornate</li> 
     <li>Nuova <a href="https://helpx.adobe.com/it/experience-manager/brand-portal/user-guide.html">guida utente di Brand Portal</a> indipendente dalle versioni e dalla guida utente di AEM Assets</li> 
    </ul> </td> 
  </tr>
 </tbody>
</table>
