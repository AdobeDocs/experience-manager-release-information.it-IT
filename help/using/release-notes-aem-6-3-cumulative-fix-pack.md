...
Il valore predefinito è 1. Sovrascrive il valore sovrapponendo il file constants.js (`/libs/cq/ui/widgets/source/constants.js`), rimuovendo il commento dalla proprietà CQ.PAGE_PROPERTIES_MAX_RECURSION_LEVEL e assegnando il valore richiesto (la profondità massima sotto `/jcr:content` della pagina in cui sono conservati i dati delle proprietà della pagina).
